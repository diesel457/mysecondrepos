...
App.prototype._init = function() {
  ...
  // TODO: Add production/development scripts
  //this.scriptUrl = null;
  ...
  if (process.env.NODE_ENV === 'production')
    this._loadProductionStyles();
};

App.prototype._getResourcePath = function(type) {
  var BUILD_CLIENT_PATH = '/build/client/';
  var prefix = '', url = '';
  switch (type) {
    case 'bundle':
      if (process.env.NODE_ENV !== 'production')
        prefix = 'http://localhost:' + (process.env.WEBPACK_PORT || 3010);
